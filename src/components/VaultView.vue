...
<template>
  <div class="space-y-4">
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center gap-1">
        ...
        <button
          v-if="vault.length > 1"
          type="button"
          class="rounded-md px-1.5 py-0.5 text-xs font-medium text-[var(--muted)] hover:bg-[var(--line)] hover:text-[var(--ink)] transition cursor-pointer"
    ...
    <!-- Notification Toast -->
    <div v-if="saveMessage" class="text-xs font-medium text-[var(--ink)] transition">
      {{ saveMessage }}
    </div>

    <!-- Grid of saved avatars -->
    <div v-if="vault.length > 0" class="grid grid-cols-4 gap-2">
      <div
      ...
      >
        ...
        <span
          v-else
          class="mt-1 w-full truncate text-center text-[11px] font-medium text-[var(--muted)] group-hover:text-[var(--ink)]"
          :title="av.name"
    ...
    <div v-else class="rounded-2xl border border-dashed border-[var(--line)] py-12 text-center">
