  ...
  >
    <ul class="flex gap-1.5 lg:flex-col">
      ...
      >
        ...
        <!-- Tooltip -->
        <span
          class="pointer-events-none absolute top-full left-1/2 z-10 mt-2.5 -translate-x-1/2 rounded-xl border border-[var(--line)] bg-[var(--ink)] px-3 py-1.5 text-xs font-medium whitespace-nowrap text-[var(--paper)] opacity-0 shadow-lg transition peer-focus-visible:opacity-100 group-hover:opacity-100 lg:top-1/2 lg:left-full lg:mt-0 lg:ml-3 lg:-translate-y-1/2 lg:translate-x-1 lg:peer-focus-visible:translate-x-0 lg:group-hover:translate-x-0"
