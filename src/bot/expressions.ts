...
export const EXPRESSIONS: BotExpression[] = [
  ...
  {
    // regard taquin, un oeil plisse et sourcil en coin
    id: 'malicieux',
    gaze: { yaw: 14, pitch: 4, roll: 5 },
    split: 16.5,
    eyes: [eye(0.22, 0.42, 12), eye(0.32, 0.16, -10)]
  },
  {
    // regard paisible, yeux doux et mi-clos
    id: 'zen',
    gaze: { yaw: 0, pitch: 8, roll: 0 },
    split: 17,
    eyes: pair(0.34, 0.12, 0, 0.3)
  },
  {
    // grands yeux ronds pleins d'emerveillement
    id: 'etoile',
  ...
  {
    // regard doux et incline vers l'interieur
    id: 'amoureux',
    gaze: { yaw: 8, pitch: -6, roll: -4 },
    split: 17.5,
    eyes: pair(0.22, 0.44, 16)
  },
  {
    // yeux etrecis de saisissement
    id: 'choque',
  ...
  {
    // un oeil grand ouvert et l'autre plisse
    id: 'doute',
    gaze: { yaw: -12, pitch: 10, roll: -10 },
    split: 16,
    eyes: [eye(0.22, 0.48), eye(0.32, 0.16, 12)]
  },
  {
    // regard en l'air et incline
    id: 'reveur',
    gaze: { yaw: -18, pitch: -16, roll: 8 },
    split: 18,
    eyes: pair(0.22, 0.44, -12)
  },
  {
    // sourcils fronces et regard determine
    id: 'determine',
    gaze: { yaw: 0, pitch: 10, roll: 0 },
    split: 16.5,
    eyes: pair(0.38, 0.2, -26)
  }
]
